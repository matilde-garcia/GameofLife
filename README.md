...
Contributors must create a secondary branch and do a pull request upon which the merge with the main branch will be approved/denied according to the status of the workflow "runtests", which preforms both unit and regression tests on the code after changes are executed.
